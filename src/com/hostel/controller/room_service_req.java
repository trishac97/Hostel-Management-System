...
@WebServlet("/room_service_req")
public class room_service_req extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public room_service_req() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		AdminDAO cdaoobj=new AdminDAO(); 	    
	      ...
	      //CALL DAO METHOD
 	    List<RoomServiceDetails> breaklist = cdaoobj.fetchAllRoomService();
	    String nextviewpage="";
