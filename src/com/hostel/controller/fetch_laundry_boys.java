...
@WebServlet("/fetch_laundry_boys")
public class fetch_laundry_boys extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public fetch_laundry_boys() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		AdminDAO cdaoobj=new AdminDAO(); 	    
	      ...
	      //CALL DAO METHOD
 	    List<HealthCareDetails> breaklist1 = cdaoobj.fetchAllMedicineBoys();
	    String nextviewpage="";
	    
	    if(breaklist1.size() > 0)
	    {
	    	request.setAttribute("servermsg2", breaklist1);
	    	nextviewpage ="Admin_medical.jsp";
	    }
	    else
	    {
	    	request.setAttribute("servermsg2", "No Complaints Found!");
	    	nextviewpage ="Admin_medical.jsp";
	    }
