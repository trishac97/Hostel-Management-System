...
@WebServlet("/fetch_medicine_girls")
public class fetch_medicine_girls extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public fetch_medicine_girls() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		AdminDAO cdaoobj=new AdminDAO(); 	    
	      ...
	      //CALL DAO METHOD
 	    List<HealthCareDetails> breaklist = cdaoobj.fetchAllMedicineGirls();
	    String nextviewpage="";
