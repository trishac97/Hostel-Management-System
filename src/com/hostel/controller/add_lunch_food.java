...
@WebServlet("/add_lunch_food")
public class add_lunch_food extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public add_lunch_food() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		LunchDetails breakobj=new LunchDetails();
...
//CALL DAO METHOD
boolean replyfromdao=cdaoobj.addLunch(breakobj);
	    String nextviewpage="";
	    
	    if(replyfromdao)
	    {
	    	request.setAttribute("errormsg","New Lunch Added");
