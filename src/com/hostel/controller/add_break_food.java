...
@WebServlet("/add_break_food")
public class add_break_food extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public add_break_food() {
        super();
    }
...
//CALL DAO METHOD
boolean replyfromdao=cdaoobj.addBreakfast(breakobj);
	    String nextviewpage="";
	    
	    if(replyfromdao)
	    {
	    	request.setAttribute("errormsg","New Breakfast Added");
