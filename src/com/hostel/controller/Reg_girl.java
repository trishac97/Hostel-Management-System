...
@WebServlet("/Reg_girl")
public class Reg_girl extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
        ...
        GirlsHostelDetails docobj = new GirlsHostelDetails();
		...
		//CALL DAO METHOD
		boolean replyfromdao = cdaoobj.girlRegistration(docobj);
