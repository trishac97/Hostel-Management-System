...
<body class="fix-header card-no-border">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            <div class="card-block">
                                <form class="form-horizontal form-material"  action="Home_in_out" method="post">
    ...
    <br>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="first_name" placeholder="<%=uni_roll %>" class="form-control form-control-line" readonly="readonly">
                                        </div>
                                    </div>
                                     <div class="form-group">
                                        <label class="col-md-12">Start Date</label>
                                        <div class="col-md-12">
                                            <input type="date" name="start_date" placeholder="" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12">Return Date</label>
                                        <div class="col-md-12">
                                            <input type="date" name="end_date" placeholder="" class="form-control form-control-line"  id="example-email">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12">Hostel Name</label>
                                        <div class="col-md-12">
                                            <input type="text" name="hostel_name" placeholder="" class="form-control form-control-line"  id="example-email">
                                        </div>
                                    </div>
                                     <div class="form-group">
                                        <label for="example-email" class="col-md-12">Emergency Contact</label>
                                        <div class="col-md-12">
                                            <input type="text" name="emergency_contact" placeholder="" class="form-control form-control-line"  id="example-email">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Reason</label>
                                        <div class="col-md-12">
                                            <input type="text" name="reason" class="form-control form-control-line">
                                        </div>
                                    </div>
