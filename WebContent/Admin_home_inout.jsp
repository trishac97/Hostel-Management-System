<%@page import="com.hostel.model.HomeDetails"%>
                    ...
                    <ul class="navbar-nav mr-auto mt-md-0 ">
                        ...
                        <li class="nav-item hidden-sm-down">
                            <form class="app-search p-l-20">
                                <h2><font color="#F8F8F8">Home in/out</font></h2>
                            </form>
                        </li>
                    </ul>
                    <!-- ============================================================== -->
...
<div><br>
   ...
   <%! List<HomeDetails> hlist=null; %>  
    
  <%
  hlist=(List<HomeDetails>)request.getAttribute("servermsg");
  if(hlist!=null){%>
<table>
  ...
  <%
  for(HomeDetails hobj:hlist){
  %>
  <tr>
    <td><%=hobj.getUni_roll() %></td>
    <td><%=hobj.getStart_date() %></td>
        <td><%=hobj.getEnd_date() %></td>
        <td><%=hobj.getEmergency_contact() %></td>
        <td><%=hobj.getReason() %></td>
