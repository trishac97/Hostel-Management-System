        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                        <marquee style="background-color: rgba(0,0,255,0.2);padding-top: 10px;padding-bottom: 10px"><h2>Welcome Administrator</h2></marquee>
                                                    <form action="Admin_notice" method="post">
        ...
        if(request.getAttribute("errormsg")!=null)
        	out.print(request.getAttribute("errormsg"));%>
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea rows="5" class="form-control form-control-line" name="notice"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button class="btn btn-success">Submit Notice</button>
                                        </div>
                                    </div>
                            </div>
                            </form>
