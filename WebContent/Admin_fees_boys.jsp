                    ...
                    <ul class="navbar-nav mr-auto mt-md-0 ">
                        ...
                        <li class="nav-item hidden-sm-down">
                            <form class="app-search p-l-20">
                                <h2><font color="#F8F8F8">Fees Calculator for Boys Hostel</font></h2>
                            </form>
                        </li>
                    </ul>
                    <!-- ============================================================== -->
...
<table>
  ...
  <tr>
    ...
    <td><%=hobj.getPassword() %></td>
      ...
      <td><a  href="calculate_fees2?uni_roll=<%=hobj.getUni_roll()%>"><button type="button" class="btn btn-danger btn-sm"> Calculate Fees</button></a></button></td>      
