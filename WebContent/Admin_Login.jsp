...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images_login/bg-01.jpg');">
		  <div class="wrap-login100 p-t-30 p-b-50"><span class="login100-form-title p-b-41"> Administrator Login</span>
    ...
    <br>
			  <form class="login100-form validate-form p-b-33 p-t-5" action="Admin_Login" method="get">

					<div class="wrap-input100 validate-input" data-validate = "Enter username">
						<input class="input100" type="text" name="uni_roll" placeholder="Username">
