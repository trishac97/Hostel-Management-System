                    ...
                    <ul class="navbar-nav mr-auto mt-md-0 ">
                        ...
                        <li class="nav-item hidden-sm-down">
                            <form class="app-search p-l-20">
                                <h2><font color="#F8F8F8">List of Girl Hostelers
</font></h2>
                            </form>
                        </li>
                    </ul>
...
<table>
 ...
 %>
                   ...
                   <td><a  href="adm_auth?uni_roll=<%=hobj.getUni_roll()%>"><button type="button" class="btn btn-danger btn-sm"> Enable Student </button></a></button></td>      
                       <%
                       }
                       %>     
  </tr>
