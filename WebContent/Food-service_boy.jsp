            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                            <a href="profile_boy_details_fetch" class="waves-effect"><i class="fa fa-user m-r-10" aria-hidden="true"></i>Profile</a>
                        </li>
                        <li>
...
<!-- ============================================================== -->
                ...
                <!-- Start Page Content -->
                <!-- ============================================================== -->
  				<a href="breakfast2" class="btn pull-center hidden-sm-down btn-success" style="margin-right: 300px;margin-left: 150px">Breakfast</a>
             	<a href="lunch2" class="btn pull-center hidden-sm-down btn-success" style="margin-right: 300px;">Lunch</a>
              	<a href="dinner2" class="btn pull-center hidden-sm-down btn-success">Dinner</a><br><br>
   ...
   <tr>
     ...
     <td><%= breakobj.getItem_code() %></td>
          <td><%= breakobj.getPrice() %></td>
                     ...
                     <td><a href="Food-service3.jsp?item_code=<%=breakobj.getItem_code()%>&price=<%=breakobj.getPrice()%>&item_1=<%=breakobj.getItem_1()%>&item_2=<%=breakobj.getItem_2()%>&item_3=<%=breakobj.getItem_3()%>&item_4=<%=breakobj.getItem_4()%>&item_5=<%=breakobj.getItem_5()%>&item_6=<%=breakobj.getItem_6()%>"><button class="btn btn-danger" style="color: white"> Book Meal </button></a></td>      
   </tr>  
   ...
   <tr>
     ...
     <td><%= lunchobj.getItem_code() %></td>
          <td><%= lunchobj.getPrice() %></td>
                     ...
                     <td><button class="btn btn-danger" style="color: white"><a  href="Food-service3.jsp?item_code=<%=lunchobj.getItem_code()%>&price=<%=lunchobj.getPrice()%>&item_1=<%=lunchobj.getItem_1()%>&item_2=<%=lunchobj.getItem_2()%>&item_3=<%=lunchobj.getItem_3()%>&item_4=<%=lunchobj.getItem_4()%>&item_5=<%=lunchobj.getItem_5()%>&item_6=<%=lunchobj.getItem_6()%>"> Book Meal </a></button></td>        
   </tr>  
   ...
   <tr>
     ...
     <td><%= dinnerobj.getItem_code() %></td>
          <td><%= dinnerobj.getPrice() %></td>
                     ...
                     <td><button class="btn btn-danger" style="color: white">  <a  href="Food-service3.jsp?item_code=<%=dinnerobj.getItem_code()%>&price=<%=dinnerobj.getPrice()%>&item_1=<%=dinnerobj.getItem_1()%>&item_2=<%=dinnerobj.getItem_2()%>&item_3=<%=dinnerobj.getItem_3()%>&item_4=<%=dinnerobj.getItem_4()%>&item_5=<%=dinnerobj.getItem_5()%>&item_6=<%=dinnerobj.getItem_6()%>"> Book Meal </a></button></td>        
   </tr>  
