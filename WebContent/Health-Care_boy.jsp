                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                       <li>
                        ...
                        <li>
                            <a href="Health-Care_boy.html" class="waves-effect"><i class="fa fa-heartbeat m-r-10" aria-hidden="true"></i>Health Care</a>
                        </li>
                    </ul>
...
<table>
  ...
  <tr>
   ...
   <%! List<HealthCareChartDetails> hlist=null; %>  
    
  <%
  hlist=(List<HealthCareChartDetails>)request.getAttribute("servermsg2");
  if(hlist!=null){
  for(HealthCareChartDetails hobj:hlist){
  %>
  <tr>
    <td><%=hobj.getMedicine_name() %></td>
    <td><%=hobj.getMedicine_price() %></td>
...
<form action="Health_care2" method="post">
