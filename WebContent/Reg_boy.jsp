...
<body background="css_reg/background.png">
    ...
    <body>
      ...
      <form action="Reg_boy" method="post">
        ...
        <fieldset>
         <label for="mail">Email:</label>
		  ...
		  <label for="year">Year:</label>
			...
			&nbsp;&nbsp;&nbsp;&nbsp;
		  	<input type="radio" name="hostel_name" value="RamKrishna Hostel" checked> Ramkrishna Hostel&nbsp;&nbsp;&nbsp;&nbsp;
 			<input type="radio" name="hostel_name" value="Vivekananda Hostel"> Vivekananda Hostel<br>
			  <br>
