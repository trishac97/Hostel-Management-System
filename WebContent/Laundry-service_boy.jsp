<%@page import="com.hostel.model.LaundryChartDetails"%>
                    ...
                    <ul class="navbar-nav mr-auto mt-md-0 ">
                        ...
                        <li class="nav-item hidden-sm-down">
                            <form class="app-search p-l-20">
                                <h2><font color="#F8F8F8">Laundry Service</font></h2>
                            </form>
                        </li>
                    </ul>
                    <!-- ============================================================== -->
...
<!-- ============================================================== -->
                ...
                <!-- ============================================================== -->
		                        ...
		                        <marquee style="background-color: rgba(0,0,255,0.2);padding-top: 5px;padding-bottom: 5px"><h5>Please refer to the weighing chart and enter the exact weight</h5></marquee>
...
<table>
  ...
  <tr>
   ...
   <%! List<LaundryChartDetails> laulist=null; %>  
    
  <%
  laulist=(List<LaundryChartDetails>)request.getAttribute("servermsg2");
  if(laulist!=null){
  for(LaundryChartDetails lauobj:laulist){
  %>
  <tr>
    <td><%=lauobj.getWeight() %></td>
    <td><%=lauobj.getPrice() %></td>
...
<form action="Laundry_service2" method="post">
  <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="weight" placeholder="" class="form-control form-control-line">
                                        </div>
                                    </div>
                                     <div class="form-group">
