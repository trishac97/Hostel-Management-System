...
<!-- ============================================================== -->
                ...
                <!-- Start Page Content -->
                <!-- ============================================================== -->
  				<a href="com_girls" class="btn pull-center hidden-sm-down btn-success" style="margin-right: 300px;margin-left: 150px">Fetch Complaint(Girls)</a>
             	<a href="com_boys" class="btn pull-center hidden-sm-down btn-success" style="margin-right: 300px;">Fetch Complaint(Boys)</a>
...
<%! List<ComplaintGirlsDetails> breaklist=null; %>  
  <%
     breaklist=(List<ComplaintGirlsDetails>)request.getAttribute("servermsg");
  if(breaklist != null)
  {
  %>
 ...
 <%
   ...
   for(ComplaintGirlsDetails breakobj : breaklist)
   {
 %>
   <tr>
     <td><%= breakobj.getUni_roll() %></td>
     <td><%= breakobj.getComplaint() %></td>
     <td><%= breakobj.getDate() %></td>
...
<%! List<ComplaintBoysDetails> breakslist=null; %>  
  <%
     breakslist=(List<ComplaintBoysDetails>)request.getAttribute("servermsgs");
  if(breakslist != null)
  {
  %>
  <h1>Complaints Table</h1><br>
 ...
 <%
   ...
   for(ComplaintBoysDetails breaksobj : breakslist)
   {
 %>
   <tr>
     <td><%= breaksobj.getUni_roll() %></td>
     <td><%= breaksobj.getComplaint() %></td>
     <td><%= breaksobj.getDate() %></td>
