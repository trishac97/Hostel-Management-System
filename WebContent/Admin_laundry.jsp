                    ...
                    <ul class="navbar-nav mr-auto mt-md-0 ">
                        ...
                        <li class="nav-item hidden-sm-down">
                            <form class="app-search p-l-20">
                                <h2><font color="#F8F8F8">Laundry Request Lists</font></h2>
                            </form>
                        </li>
                    </ul>
                    <!-- ============================================================== -->
...
<!-- ============================================================== -->
        ...
        if(request.getAttribute("errormsg")!=null)
        	out.print(request.getAttribute("errormsg"));%>
					...
					<a href="fetch_laundry_girls" class="btn pull-center hidden-sm-down btn-success" style="margin-right: 300px;margin-left: 150px">Fetch Laundry (Girls Hostel)</a>
             	<a href="fetch_laundry_boys" class="btn pull-center hidden-sm-down btn-success" style="margin-right: 300px;">Fetch Laundry (Boys Hostel)</a>
              	
<div><br><br><br>
<div>

<%! List<LaundryDetails> breaklist=null; %>  
  <%
     breaklist=(List<LaundryDetails>)request.getAttribute("servermsg");
  if(breaklist != null)
  {
  %>
 <table id="alter">  
